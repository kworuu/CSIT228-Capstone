...
--
-- Host: 127.0.0.1
-- Generation Time: May 10, 2026 at 08:09 PM
...
INSERT INTO `evacuation_centers` (`id`, `name`, `address`, `barangay`, `photo_path`, `capacity`, `current_occupancy`, `latitude`, `longitude`, `managed_by`, `is_active`, `created_at`) VALUES
(1, 'Lahug Elementary School', 'Salinas Drive, Lahug, Cebu City', 'Lahug', NULL, 600, 0, 10.343900, 123.900000, NULL, 1, '2026-05-07 13:04:41'),
(2, 'Mabolo National High School', 'A. Soriano Avenue, Mabolo, Cebu City', 'Mabolo', NULL, 800, 0, 10.323200, 123.912300, NULL, 1, '2026-05-07 13:04:41'),
(3, 'Guadalupe Elementary School', 'V. Rama Avenue, Guadalupe, Cebu City', 'Guadalupe', NULL, 500, 0, 10.312000, 123.884300, NULL, 1, '2026-05-07 13:04:41');
...
(1, 'admin', 'PLACEHOLDER_REPLACE_ON_FIRST_RUN', 'admin@civicguard.test', 'Cebu City Admin', 'admin', NULL, 'Lahug', '2026-05-07 13:04:41', NULL);
